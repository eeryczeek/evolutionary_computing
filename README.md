...
| **Algorithm**         | **Min** | **Mean** | **Max** | **Time to solve all 200 instances (s)** |
| --------------------- | ------- | -------- | ------- | --------------------------------------- |
| `random`              | 237008  | 263994   | 294340  | 0.01                                    |
| `greedy tail`         | 83182   | 85108    | 89433   | 0.04                                    |
| `greedy any position` | 78896   | 80974    | 82368   | 0.80                                    |
| `greedy cycle`        | 71488   | 72609    | 74410   | 0.52                                    |
...
| **Algorithm**         | **Min** | **Mean** | **Max** | **Time to solve all 200 instances (s)** |
| --------------------- | ------- | -------- | ------- | --------------------------------------- |
| `random`              | 187379  | 213728   | 240409  | 0.01                                    |
| `greedy append`       | 52319   | 54390    | 59030   | 0.02                                    |
| `greedy any position` | 52992   | 55015    | 57460   | 0.63                                    |
| `greedy cycle`        | 48765   | 51301    | 57324   | 0.47                                    |
...
![greedy_any_position.png](plots/greedy_any_position.png.png)
...
![greedy_cycle.png](plots/greedy_cycle.png.png)
